...
#create a DataFrame
samplot_input_hg002_3_4 = pd.DataFrame(columns=['ID', 'CHROM', 'START', 'END', 'Type'])
...
for i in range(len(sniffles_hg002_3_4)):
    ...
    df=pd.DataFrame([new_row], columns=['ID', 'CHROM', 'START', 'END', 'Type'])
    #concat the 2 dataframes
    samplot_input_hg002_3_4=pd.concat([samplot_input_hg002_3_4, df])

#save the data frame as a csv
samplot_input_hg002_3_4.to_csv('samplot_input_hg002_3_4.csv', index=False)
